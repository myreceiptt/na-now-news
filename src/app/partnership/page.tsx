...
function PartnerShip() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="mx-auto max-w-3xl flex flex-col gap-8 border-b border-dark-now dark:border-light-now"
    >
      <div className="">
      ...
      <div className="">
        ...
        <h3 className="block text-sm sm:text-base text-yellow-now dark:text-green-now font-judul border-b border-dark-now dark:border-light-now">
          Use a permanent address in Universe of Reality where you can receive
          mail physically.
        </h3>
        <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-6">
          ...
          <div className="col-span-full sm:col-span-2 sm:col-start-1">
            <label htmlFor="city" className="text-sm sm:text-base font-judul">
              City *
            </label>
            <div className="mt-2">
              <input
      ...
      <div className="">
        ...
        <h3 className="block text-sm sm:text-base text-yellow-now dark:text-green-now font-judul border-b border-dark-now dark:border-light-now">
          ...
          provide the information truthfully so we can consider it as best as
          possible.
        </h3>
        <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-6">
          <div className="mt-4 col-span-full">
      ...
      <div className="">
        ...
        <h3 className="block text-sm sm:text-base text-yellow-now dark:text-green-now font-judul border-b border-dark-now dark:border-light-now">
          Double check your information. Make sure all information is correct.
          After you send the request, we will get back to you as soon as
          possible.
        </h3>
        <div className="grid grid-cols-1 gap-x-4 gap-y-4">
